...
-- sorteados, y todas las rifas flash con sus opciones. No toca los
-- usuarios ni sus roles: Key, Jacky y el admin siguen entrando igual.
--
...
delete from public.flash_numeros;
delete from public.flash_marcas;
delete from public.flash_opciones;
delete from public.flash_rifas;
...
-- Comprobación: todas tienen que dar 0.
select
  ...
  (select count(*) from public.flash_rifas)   as rifas_flash,
  (select count(*) from public.flash_numeros) as numeros_flash;
